...
\begin{document}
\section{Gondola Arm}
The faliure of the gondola arm will be anaylsed in a very simliar fashion to the gondola arm deflection. Once again, Figure \ref{fig:deflection} is used as the basis for the analysis. Instead of deflection however, stress at the inner corner of the arm is found as:
\begin{align}
	\sigma _{Gondola Arm} = \sigma _{axial} + \sigma _{bending force} + \sigma _{bending moment} \\ \label{armDeflection}
