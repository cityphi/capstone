...
50\% will be added to the computed value of drag to account for differences in build, as well as the contribution to the drag of the gondola, thrusters and keel. Therefore the value of drag used in computations is 21.239N.
