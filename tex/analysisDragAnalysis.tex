...
An analysis from a report called \textit{Technical Manual of Airship Aerodynamics} \cite{airshipAerodynamics} was used to determine the drag forces acting on the airship. The following formula was used to compute drag:
